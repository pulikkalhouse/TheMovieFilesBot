...
"""
    ...
    FILE_CAPTION = """<b><a href=https://t.me/B4UMOVIEHOUSE><b>{file_name}</b></a>\n\n𝖩𝗈𝗂𝗇➥ 「<a href="https://t.me/+YzxkJfGbKcswZjNl">𝗨𝗽𝗱𝗮𝘁𝗲 𝗺𝗼𝘃𝗶𝗲 𝗰𝗵𝗮𝗻𝗻𝗲𝗹</a>」</b>"""
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/yaduvanshiXD'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
🆔 ᴜᴘɪ ɪᴅ ➩ <code>pradeep938@barodampay</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
...
--------------Movie Update--------------
➩ /movie_update_on - Enable Movie Update
➩ /movie_update_off - Disable Movie Update
--------------Verify ID--------------
...
➩ /del_ads - Delete ads
-------------Top Trending------------
➩ /setlist {Mirzapur, Taaza Khabar} - <a href=https://t.me/Jisshu_developer/10>Explain</a>
...
--------------Verify On Off------------
/verifyoff {{verify.off code}} - off verification <a href="https://t.me/yaduvanshiXD">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ ᴄᴏᴅᴇ
...
Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴜsᴇ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs😇</b>"""
    ...
    SOURCE_TXT = """<b>
NOTE:
- ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<blockquote><a href="https://t.me/+CIXq0QHYnzdiMWM1">𝗧𝗵𝗲-𝗙𝗶𝗹𝘁𝗲𝗿-𝗕𝗼𝘁</a></blockquote>
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="https://t.me/YaduvanshiXD">ᴄᴏɴᴛᴀᴄᴛ</a> ᴍʏ <a href="https://t.me/YaduvanshiXD">ᴀᴅᴍɪɴ</a></b>"""
